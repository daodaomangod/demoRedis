...
@RestController
@RequestMapping("/api/sdev-kafka")
public class SdevKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SdevKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SdevKafkaResource(KafkaProperties kafkaProperties) {
